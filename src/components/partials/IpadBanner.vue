<template>
    <a href="/product/3">
        <section class="tw-bg-black tw-flex tw-py-10 tw-mt-20">
            ...
            <div class="tw-my-auto tw-flex tw-mx-auto">
                <img class="tw-h-full tw-flex tw-justify-center tw-items-center"
                    src="https://res.cloudinary.com/dcm40dfr5/image/upload/v1711970406/c4_vnxipj.png" alt="iPad">
            </div>
        </section>
    </a>
</template>